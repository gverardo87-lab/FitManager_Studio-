...
- **Seed data**: 500 esercizi + 940 relazioni + 750 media nei seed JSON (`data/exercises/`), seed idempotente al startup in catalog.db. In DB dopo filtro FK orfane: 466 attivi, 894 relazioni, 750 media (seed media potato 1788→750 il 2026-06-13, §5.6.4 — niente più orfani pre-rebuild). Junction tassonomiche in catalog.db: 6.996 muscoli / 1.452 articolazioni / 5.154 condizioni (vedi `docs/archive/operations/DB_INTEGRITY_AUDIT_2026-06-14.md`).
