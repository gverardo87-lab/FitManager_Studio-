...
def main():
    ...
    print(f"  [ ] Access managed FRP origin from an external network")
    print(f"  [ ] Verify strict TLS and public portal route returns 200")
    print(f"  [ ] Verify CRM routes return 404 through the public hostname")
