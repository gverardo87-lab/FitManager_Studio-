...
**Domande aperte:** [ ] scegliere e dichiarare il modello (A trunk-based vs B linea di release) — oggi è ambiguo; [ ] regola "ogni `build-release.sh` fa avanzare `main` fino al tag" se si adotta B; [ ] rami zombie `codex_02` e `fit_launch_01` — archiviare o cancellare per non lasciare ref morti.
