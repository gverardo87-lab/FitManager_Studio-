...
| 2 | P2 | Backend | 9 repository legacy (sqlite3 raw) usati solo da core/ | Rimossi 2026-03-25 (~3,800 LOC dead code) | closed |
| 3 | P2 | Backend | FinancialRepository + CardImportRepository legacy (dict raw) | Rimossi 2026-03-25 (inclusi nella pulizia repositories) | closed |
