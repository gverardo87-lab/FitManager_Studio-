...
| File | Stato | Scopo |
|------|-------|-------|
| `SPEC_R0_PROTEZIONE_RELEASE_V1_0_15.md` | 🟠 **APERTA — R0.1 + R0.1.5-core + R0.2 + R0.3 ✅; R0.1.5-live HOLD; R0.4 BLOCCATO** | R0.3 riallinea ContrattiTab al netto wire, rimuove importi dalla preview cliente globale e la stima monetaria delle sedute residue, sincronizza il tour Clienti; FE 161/161, guard 11/11, build verde e MONEY AXIS PRESERVED. Apply edge + chain pubblica + probe strict restano interlock obbligatorio prima di R0.4/P |
