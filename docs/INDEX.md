...
| `SPEC_FRONTEND_CORE_INTUITIVITA.md` | 🟡 **APERTA — FE-0 CHIUSO; prossimo FE-1.0 autorizzato** | Remediation audit frontend core. FE-0 privacy/truth state ✅; FE-1.0 introduce la vertical slice del Contextual Deep-Link Contract v1 (`Clienti → Rinnovi & Incassi → rata scaduta`) prima di P1, senza auto-apertura money-path; FE-2..4 restano gated e fuori dal perimetro immediato |
