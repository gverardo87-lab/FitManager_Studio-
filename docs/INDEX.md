...
| `AUDIT_PRE_RELEASE_2026-07-16.md` | **Triade auditor + runbook attivo v1.0.14.** Evidenza originaria: MONEY AXIS PRESERVED (394 oracle) + finding docs/semantici. **R1-code CHIUSO** in `41d62e8`: 873 pytest verdi, `check-all` verde, verifier mirato **MONEY AXIS PRESERVED**, zero coverage gap. Questo fold-back chiude R1-docs; prossimo gate operativo: **OD-1** read-only sui backup Alessio+Chiara, poi bump e pipeline ADR-004 |
