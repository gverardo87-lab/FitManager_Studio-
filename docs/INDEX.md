...
| File | Stato | Scopo |
|------|-------|-------|
| `SPEC_R0_PROTEZIONE_RELEASE_V1_0_15.md` | 🟠 **APERTA — R0.1 + R0.1.5-core + R0.2 + R0.3 + R0.1.5-live ✅; R0.4 PROSSIMO** | Edge HTTP-01 applicato con rollback provato e listener/UFW 80 verificati; emissione reale Let's Encrypt sul PC trainer e probe strict completi: HTTP non-challenge 404, trust+SAN PASS, health/public 200, CRM 404. R0.4 resta un gate docs/operations separato prima di P/candidate |
