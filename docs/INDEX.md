...
| `SPEC_FRONTEND_CORE_INTUITIVITA.md` | 🟡 **APERTA — FE-0 CHIUSO; FE-1.0 IN VALIDAZIONE LIVE** | Remediation audit frontend core. FE-0 privacy/truth state ✅; FE-1.0 Contextual Deep-Link Contract v1 implementato (`Clienti → Rinnovi & Incassi → rata scaduta`, `f678292`) con 148/148 test e MONEY AXIS PRESERVED; manca validazione LIVE founder prima della chiusura. FE-2..4 restano gated |
