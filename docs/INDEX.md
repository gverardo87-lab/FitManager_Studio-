...
| File | Stato | Scopo |
|------|-------|-------|
| `SPEC_R0_PROTEZIONE_RELEASE_V1_0_15.md` | 🟠 **APERTA — R0.1 + R0.1.5-core ✅; R0.1.5-live HOLD; R0.2 prossimo** | R0-D1 (2026-07-26) separa implementazione TLS già verde dal closeout VPS non eseguito: R0.2/R0.3 possono procedere, ma apply edge + chain pubblica + probe strict restano interlock obbligatorio prima di R0.4/P. ADR-011 Add. I, chiave locale, HTTP-01 ristretto e zero credenziali DNS invariati; nessun PASS derivato dalla sola osservazione browser locale |
