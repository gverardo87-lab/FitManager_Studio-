...
| `SPEC_G8.4_TRASPARENZA_FINANZIARIA_FE.md` | 🟡 IN CORSO — **fetta-RIGORE (F1+F5) ✅ 2026-07-06** · restano F2+F6, F3 | Trasparenza finanziaria frontend. Fatto: netto SSoT + `saldo_progressivo` + guard FE-no-money-math + split <300 (4 commit `5086045`..`1978572`). D-2 «Saldo» ledger → **ADR-019 Add. IV**; D-1 emendata (breakdown = sub-label always-visible); ricerca `archive/RICERCA_COMPETITOR_TRASPARENZA_FINANZIARIA_2026-07-06.md`. Restano: F2+F6 (disclosure+colore), F3.a/c/d/e (raccomandazione+a11y+penali; F3.f già in codice), G8.5 governance-first |
