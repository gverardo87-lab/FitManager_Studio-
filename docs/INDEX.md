...
| `SPEC_FRONTEND_CORE_INTUITIVITA.md` | 🟡 **APERTA — FE-0 CHIUSO; FE-1.0 IN RETEST LIVE** | Remediation audit frontend core. FE-0 privacy/truth state ✅; FE-1.0 implementato (`f678292`), fix router-only (`d382a4b`) completato dal coordinamento con scroll restore/cache (`8f5ca45`), con 151/151 test e MONEY AXIS PRESERVED; manca il retest LIVE founder. FE-2..4 restano gated |
