...
| `SPEC_G8.4_TRASPARENZA_FINANZIARIA_FE.md` | 🟡 IN CORSO — **F1+F5 ✅ · F2+F6 ✅** · resta F3 | Trasparenza finanziaria frontend. Fatto: netto SSoT + `saldo_progressivo` + guard FE-no-money-math + split <300 (`5086045`..`1978572`) · disclosure D-1 + colore semantico F6 (`0b80bc8`, AC-G84-5 render-test). D-2 «Saldo» ledger → **ADR-019 Add. IV**; ricerca `archive/RICERCA_COMPETITOR_TRASPARENZA_FINANZIARIA_2026-07-06.md`. Restano: F3.a/c/d/e (raccomandazione+a11y+penali; F3.f già in codice), G8.5 governance-first |
