...
| **Crediti residui (derivato FE)** | n/a | ✅ D4: `crediti_residui` sul wire, i dialog LEGGONO (G9.7.3) | n/a | ✗ guard FE copre solo denaro (G9.7.4) | ✅ vedi occupazione (G9.7.3) | n/a |
...
Ultimo aggiornamento: 2026-07-11 (G9.7.3 chiuso: celle DV occupazione-credito + R2/DV crediti-residui → ✅).
